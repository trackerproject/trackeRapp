...
```{r}
embed_youtube("oJn8MiB3mHQ", width = '650', height = '365.63') %>% div(align = 'center') 
```
...
```{r}
embed_youtube("6KnKSXNLBJo", width = '650', height = '365.63') %>% div(align = 'center') 
```
...
```{r}
embed_youtube("KGvQZV7srRI", width = '650', height = '365.63') %>% div(align = 'center') 
```
...
```{r}
embed_youtube("KPu-TNuyIr4", width = '650', height = '365.63') %>% div(align = 'center') 
```
...
```{r}
embed_youtube("MrQRwdGdkuI", width = '650', height = '365.63') %>% div(align = 'center') 
```
...
```{r}
embed_youtube("EDxV-4Z37FE", width = '650', height = '365.63') %>% div(align = 'center') 
```
