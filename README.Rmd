...
knitr::include_graphics('Images_readme/evening_sessions.png')
```

<br>

```{r out.width='95%', fig.align='center', echo=FALSE}
knitr::include_graphics('Images_readme/map.png')
```

<br>

```{r out.width='95%', fig.align='center', echo=FALSE}
knitr::include_graphics('Images_readme/session_summaries.png')
```
...
knitr::include_graphics('Images_readme/zones_multiple_sessions.png')
```
