...
ui <- shinydashboard::dashboardPage(
  ...
  shinydashboard::dashboardBody(
                      ...
                      shinyjs::hidden(div(id = "firefoxmessage",
                                          ...
                                          div(img(src = "text_trackeRapp.svg", width = "120em"), "has difficulties rendering interactive plots in Firefox",
                                              style = "font-size: 1.5em; text-align: center; color: #222d32"),
                                          div(icon("sad-tear"),
                                              style = "font-size: 3em; text-align: center; color: #222d32"),
                                          div("Please use another browser while we are investigating the issue",
                                              style = "font-size: 1.5em; text-align: center; color: #222d32"))),
                      shinyjs::useShinyjs(),
