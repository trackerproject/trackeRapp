...
ui <- shinydashboard::dashboardPage(
  ...
  shinydashboard::dashboardSidebar(
                      ...
                      shinydashboard::sidebarMenu(
                                          ...
                                          hr(),
                                          div(class = "form-group shiny-input-container",
                                              p(span(id = "important_text", "Wishes, issues and stars"),
                                                br(),
                                                a("trackerproject", icon("github"),
                                              ...
                                              p(#icon("question"),
                                                ...
                                                br(),
                                                a("Tour de trackeRapp", icon("question"),
                                                  href = "https://trackerproject.github.io/trackeRapp/",
                                                  target = "_blank"),
                                                br(),
                                                a("YouTube channel", icon("youtube"),
                                                  href = "https://www.youtube.com/channel/UCY6y-pw8d1kek1WAIWiVhhw",
                                                  target = "_blank")),
                                              p(#icon("code"),
                                                span(id = "important_text", "Design and development"),
                                                br(),
                                                "Robin Horňák",
